...
function synthesis_vowel_no_noise_diph(filename,vowel1,vowel2)
% load('A_filters.mat')
% load('U_filters.mat')
% load('I_filters.mat')
...
6897.899
8000]
    disp(formantfrequencies1)
    formantbandwidths1 = [47.92 
76.90111111
500.6022222
568.3688889
251.0244444
...
718.678
271.586]
disp(formantbandwidths1)
elseif vowel1 =='i'
    formantfrequencies1 = [287.364
2281.456
2930.192
3170.431
3919.456
...
6897.899
8000]
    disp(formantfrequencies2)
    formantbandwidths2 = [47.92 
76.90111111
500.6022222
568.3688889
251.0244444
...
375.0477778
426.3288889]
    disp(formantbandwidths2)
elseif vowel2 =='a'
formantfrequencies2 =[73.914
780.165
1196.058
2661.916
3323.918
...
[a,x1,f1_freq,sigma_freq] = genH2_ImpResp(fs,formantfrequencies1,formantfrequencies2,excitation) ;
