...
function synthesis_vowel_OB8000(filename,required_snr)
...
OBnoise8000  = filter(Octavebandfilter8000,noise1);
snrr = snr(e,OBnoise8000);
e4 = e + OBnoise8000;
%plot(t,e4)
